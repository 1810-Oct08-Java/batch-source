...
/*
ArrayList<String> oHTML = listHTML("/home/raymundo/Destroy/Projet/src/main/webapp/static/test.html");
for (int i=0; i<oHTML.size(); i++){
pw.write(oHTML.get(i));	}
*/
/*
ArrayList<String> oHTML = listHTML("/home/raymundo/Destroy/Projet/src/main/webapp/static/test.html");
for (int i=0; i<oHTML.size(); i++){
...
pw.write(" <div class = \"container\"> <table class=\"table table-hover\" width=\"85%\" > <caption>Profile Information</caption> ");
