 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://service.revature.com/", wsdlLocation = "http://192.168.51.18:8080/HelloWorldSoapService/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://service.revature.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.51.18:8080/HelloWorldSoapService/hello?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://service.revature.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.revature.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
